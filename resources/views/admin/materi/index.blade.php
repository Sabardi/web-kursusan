            ...
            <div class="modal-body">
                <form id="courseForm">
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="jenis_kursus" name="jenis_kursus" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control" id="embed_link" name="embed_link" placeholder="Masukkan Embed Link" required>
                    </div>
                </form>
            </div>
